...
use AtlanteIt\EmployeeBundle\Entity\Role;
use AtlanteIt\EmployeeBundle\Form\RoleType;
...
class RoleController extends Controller
{
    ...
    public function indexAction()
    {
        ...
        $roles = $em->getRepository('EmployeeBundle:Role')->findAll();
    ...
    {
        $role = new Role();
        $form = $this->createForm('AtlanteIt\EmployeeBundle\Form\RoleType', $role);
    ...
    {
        $deleteForm = $this->createDeleteForm($role);
        $editForm = $this->createForm('AtlanteIt\EmployeeBundle\Form\RoleType', $role);
